  ...
  return (
    <div className="mt-[10rem] relative">
      ...
      <div className="absolute top-[4.375rem] left-1/2 -translate-x-1/2 text-center">
        <p className="text-[3.25rem] font-semibold text-secondary">
          {pageContent?.bloc_6?.title}
        </p>
        <p className="text-[3.25rem] font-semibold text-secondary opacity-50 -mt-6">
          {pageContent?.bloc_6?.subtitle}
        </p>
        <p className="text-2xl w-[650px] mt-2 text-secondary">
